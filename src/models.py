...
class SkillFrontmatter(BaseModel):
    ...
    skill_id: str = Field(..., pattern=r"^yc-[a-z]+(-[a-z]+){1,6}$", description="Unique skill identifier")
    name: str = Field(..., max_length=100, description="Skill name")
    version: str = Field(default="1.0.0", pattern=r"^\d+\.\d+\.\d+$", description="Skill version")
    category: str = Field(..., description="Skill category")
    tags: List[str] = Field(..., min_length=1, max_length=10, description="Tags associated with the skill")
    ...
    related_skills: List[str] = Field(default_factory=list, description="List of related skill IDs")
    confidence: float = Field(..., ge=0.0, le=1.0, description="Confidence score of synthesis")
...
class ExtractedItem(BaseModel):
    ...
    type: Literal["framework", "warning", "advice", "story"] = Field(..., description="Type of extraction")
...
class SynthesisResponse(BaseModel):
    ...
    skill_id: str = Field(..., pattern=r"^yc-[a-z]+(-[a-z]+){1,6}$", description="Generated skill identifier")
    name: str = Field(..., max_length=100, description="Skill name")
    category: str = Field(..., description="Skill category")
