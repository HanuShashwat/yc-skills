...
def generate_index(skills_dir: str = "skills", output_path: str = "skills-index.json") -> None:
...
def generate_similarity_matrix(skills_dir: str = "skills", output_path: str = "data/similarity_matrix.json") -> None:
